...
const SCORING_SIGNALS = [
  ...
  {
    category: "מודעות וידאו",
    description: "כבר משקיע בוידאו — צריך שדרוג",
    tiers: [
      { label: "3+ וידאו", points: "+3", strength: 1.0, color: "rgb(74,222,128)" },
      { label: "2 וידאו", points: "+2", strength: 0.65, color: "rgb(250,204,21)" },
      { label: "1 וידאו", points: "+1", strength: 0.35, color: "rgb(129,140,248)" },
    ],
  },
  {
    category: "טקסט המודעה",
    description: "מודעה עם הצעה / מחיר = כוונה מסחרית ברורה",
    tiers: [
      { label: "הצעה / מחיר / יתרון ספציפי", points: "+3", strength: 1.0, color: "rgb(74,222,128)" },
      { label: "יש טקסט מודעה אמיתי", points: "+2", strength: 0.65, color: "rgb(250,204,21)" },
    ],
  },
  {
    category: "עוקבי אינסטגרם",
    description: "נוכחות חברתית = תקציב שיווקי קיים",
    tiers: [
      { label: "50,000+ עוקבים", points: "+3", strength: 1.0, color: "rgb(74,222,128)" },
      { label: "10,000–50,000", points: "+2", strength: 0.65, color: "rgb(250,204,21)" },
      { label: "1,000–10,000", points: "+1", strength: 0.35, color: "rgb(129,140,248)" },
    ],
  },
];

const TIER_SCALE = [
  { label: "חם 🔥", range: "8–10", color: "rgb(251,146,60)", bg: "rgba(251,146,60,0.1)", border: "rgba(251,146,60,0.25)" },
  { label: "ביניים 🌡", range: "5–7", color: "rgb(250,204,21)", bg: "rgba(250,204,21,0.08)", border: "rgba(250,204,21,0.2)" },
  { label: "קר ❄️", range: "1–4", color: "rgb(129,140,248)", bg: "rgba(99,102,241,0.08)", border: "rgba(99,102,241,0.2)" },
];
...
export default async function DashboardPage() {
  ...
  return (
    <div className="p-4 sm:p-8 max-w-5xl" style={{ fontFamily: F }} dir="rtl">
      <div className="mb-10">
